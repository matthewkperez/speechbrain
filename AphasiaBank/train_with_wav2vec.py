...
def dataio_prepare(hparams):
    ...
    label_encoder.load_or_create(
        path=lab_enc_file,
        from_didatasets=[train_data, valid_data, test_data],
...
if __name__ == "__main__":
    ...
    # # create HF dataset
    # HF_dataset_dir = f"/z/mkperez/AphasiaBank/data/{HF_dataset_title}"
    # dataset = load_dataset("audiofolder", data_dir=HF_dataset_dir) 
    # # TODO: stratify dataset using severity bins
    # dataset = dataset['train'].train_test_split(test_size=0.1, seed=hparams["seed"], shuffle=True)
